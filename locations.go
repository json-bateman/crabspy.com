...
var Locations = []Location{
	...
	{"Cathedral", []string{"Priest", "Beggar", "Sinner", "Tourist", "Sponsor", "Chorister", "Parishioner"}},
	{"Circus Tent", []string{"Acrobat", "Animal Trainer", "Magician", "Fire Eater", "Clown", "Juggler", "Visitor"}},
	{"Corporate Party", []string{"Entertainer", "Manager", "Unwanted Guest", "Owner", "Secretary", "Delivery Boy", "Accountant"}},
	{"Crusader Army", []string{"Monk", "Imprisoned Saracen", "Servant", "Bishop", "Squire", "Archer", "Knight"}},
	{"Casino", []string{"Bartender", "Head Security Guard", "Bouncer", "Manager", "Hustler", "Dealer", "Gambler"}},
	{"Day Spa", []string{"Stylist", "Masseuse", "Manicurist", "Makeup Artist", "Dermatologist", "Beautician", "Customer"}},
	{"Anime Meetup", []string{"Organizer", "Attendee", "Attendee", "Bartender", "Musician", "Clueless Customer", "Clueless Customer"}},
	...
	{"Hotel", []string{"Doorman", "Security Guard", "Manager", "Housekeeper", "Bartender", "Bellman", "Customer"}},
	...
	{"Space Station", []string{"Engineer", "Alien", "Pilot", "Commander", "Scientist", "Doctor", "Space Tourist"}},
